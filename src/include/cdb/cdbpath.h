...
extern Path *create_motion_path_for_ctas(PlannerInfo *root, GpPolicy *policy, int2vector *ykr, Path *subpath);
extern Path *create_motion_path_for_insert(PlannerInfo *root, GpPolicy *targetPolicy,int2vector *ykr, Path *subpath);
extern Path *create_motion_path_for_upddel(PlannerInfo *root, Index rti, GpPolicy *targetPolicy, int2vector *ykr, Path *subpath);
extern Path *create_split_update_path(PlannerInfo *root, Index rti, GpPolicy *targetPolicy, int2vector *ykr, Path *subpath);
